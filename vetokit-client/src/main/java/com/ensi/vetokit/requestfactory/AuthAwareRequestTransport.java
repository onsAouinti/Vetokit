package com.ensi.vetokit.requestfactory;
...
/**
 * Extends {@link com.google.web.bindery.requestfactory.gwt.client.DefaultRequestTransport} to handle unauthenticated requests (HTTP status 401 (Unauthorized)).
 *
